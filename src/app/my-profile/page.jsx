  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 py-12 px-4">
      <div className="max-w-md mx-auto bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl overflow-hidden">
        ...
        {/* Banner Identity */}
        <div className="h-32 bg-gradient-to-r from-cyan-500 to-purple-600 relative"></div>
        ...
        <div className="px-6 pb-6 relative">
          ...
          <div className="space-y-4">
            <div>
              <h2 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">{currentUser.name}</h2>
              <p className="text-xs font-medium text-slate-400 mt-0.5">Verified Network Identity</p>
            </div>

            <div className="border-t border-slate-100 dark:border-slate-800 pt-4 space-y-3">
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">Email Address</label>
                <span className="text-sm font-medium font-mono">{currentUser.email}</span>
              </div>
              <div>
                <label className="text-[10px] font-black uppercase tracking-wider text-slate-400 block">Account Status</label>
