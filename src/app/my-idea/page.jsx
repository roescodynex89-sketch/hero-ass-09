...
export default function MyIdeasPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(errData.message || "Wipe command execution failed");
      }
    } catch (err) {
      toast.error("Wipe command execution failed");
    }
  ...
  const openUpdateModal = (idea) => {
    ...
    setEditForm({
      title: idea.title,
      shortDescription: idea.shortDescription,
      estimatedBudget: idea.estimatedBudget ? Number(idea.estimatedBudget) : "",
      category: idea.category,
    });
  };
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full mt-1 p-2.5 text-sm rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900"
                    >
                      <option value="Tech">Tech</option>
                      <option value="AI">AI</option>
                      <option value="Health">Health</option>
